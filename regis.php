...
<div="scroll">
	...
	<div class="login">
	<br><br><br><br>
	<h1 style="color:white; letter-spacing:3px; margin-top:5px"> REGISTER</h1><br><br>
	&nbsp;
	<p style="color:white; font-size:20px;">Username:-
		<input type="textbox"><br><br>

	<p style="color:white; font-size:20px;">Password:-
		<input type="password"><br><br>

	 
	<p style="color:white; font-size:20px;">Re-Type Password:-
		<input type="password"><br><br>

	<p style="color:white; font-size:20px;">Email:-
		<input type="textbox"><br><br>
